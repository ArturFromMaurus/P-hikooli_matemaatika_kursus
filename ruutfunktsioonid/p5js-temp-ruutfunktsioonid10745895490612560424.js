...
function setup() {
  ...
  tekst_joonisel = createP("Funktsiooni y="+slider1.value() + "x^2+("+ slider2.value() + ")x+(" + slider3.value() +  ") graafik.");
  //katex.render("y=\\frac{"+slider1.value()+"}{x}"+slider2.value(), tekst_joonisel.elt);
  tekst_joonisel.position(width/3, height+110);
...
function draw() {
  ...
  tekst_joonisel.html("Funktsiooni y="+slider1.value() + "x^2+("+ slider2.value() + ")x+(" + slider3.value() +  ") graafik.");
}
