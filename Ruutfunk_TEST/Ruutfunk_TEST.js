...
var X_koordinaadid=Array(7);
var Y_koordinaadid=Array(7);
for (var i=0; i<7; i++){
    X_koordinaadid[i]=-10
    Y_koordinaadid[i]=-10
}
...
function Ylesanne(){
  ...
  if (lineaarliige>=0){
    lineaarliige_str="+ "+str(lineaarliige);
  } else {
    lineaarliige_str=str(lineaarliige)
  }
  ...
  LaTeX_string="y="+str(ruutliige)+"x^{2}"+lineaarliige_str+"x"+vabaliige_B_str;
...
function Kontroll(){
  ...
  nullkohad_tingimus=false;
  nullkohti_leitud=0;
  for (var i=0;i<7;i++){
    if (round_1(ruutliige*X_ide_massiiv[i]*X_ide_massiiv[i]+lineaarliige*X_ide_massiiv[i]+vabaliige_B)==0) {
      nullkohti_leitud=nullkohti_leitud+1;
    }
  }
  if (nullkohti_leitud==2){
    nullkohad_tingimus=true;
  }
  
  
  //----- Kas haripunkt on leitud? ---
  haripunkti_tingimus=false;
  haripunkte_leitud=0;
  for (var i=0;i<7;i++){
    if (X_ide_massiiv[i]==round_3(-lineaarliige/(2*ruutliige))){
      haripunkte_leitud=haripunkte_leitud+1;
      haripunkti_tingimus=true;
    }
  }
  ...
  ei_ole_kasvav=false;
  for (var i =0; i<6; i++){
    //console.log(str(X_ide_massiiv[6-i])+"*****"+ str(X_ide_massiiv[(6-i)-1]))
    if ( float(X_ide_massiiv[6-i]) <= float(X_ide_massiiv[(6-i)-1]) ){
      ei_ole_kasvav=true;
  ...
  if (tühjuse_tingimus==true){
    ...
    else if(nullkohad_tingimus==false){
    result_text.html("Nullkohad on puudu!")
    condition_for_finishing_table=false;
    result_text.style("color","red");
  } 
    else if(haripunkti_tingimus==false){
    result_text.html("Haripunkt on puudu!")
    condition_for_finishing_table=false;
    result_text.style("color","red");
  } 
  ...
  else if (tühjuse_tingimus==false && ei_ole_kasvav==false && nullkohad_tingimus==true && haripunkti_tingimus==true) {
    func_Y_väärtus_1=round_1(( ruutliige*INPUT_X1.value()*INPUT_X1.value()+lineaarliige*INPUT_X1.value()+vabaliige_B));
    func_Y_väärtus_2=round_1(( ruutliige*INPUT_X2.value()*INPUT_X2.value()+lineaarliige*INPUT_X2.value()+vabaliige_B))
    func_Y_väärtus_3=round_1(( ruutliige*INPUT_X3.value()*INPUT_X3.value()+lineaarliige*INPUT_X3.value()+vabaliige_B))
    func_Y_väärtus_4=round_1(( ruutliige*INPUT_X4.value()*INPUT_X4.value()+lineaarliige*INPUT_X4.value()+vabaliige_B))
    func_Y_väärtus_5=round_1(( ruutliige*INPUT_X5.value()*INPUT_X5.value()+lineaarliige*INPUT_X5.value()+vabaliige_B))
    func_Y_väärtus_6=round_1(( ruutliige*INPUT_X6.value()*INPUT_X6.value()+lineaarliige*INPUT_X6.value()+vabaliige_B))
    func_Y_väärtus_7=round_1(( ruutliige*INPUT_X7.value()*INPUT_X7.value()+lineaarliige*INPUT_X7.value()+vabaliige_B))
    //console.log(func_Y_väärtus_1,func_Y_väärtus_2, func_Y_väärtus_3, func_Y_väärtus_4, func_Y_väärtus_5,func_Y_väärtus_6,func_Y_väärtus_7)
    if (round_1(INPUT_Y1.value()) == func_Y_väärtus_1 && round_1(INPUT_Y2.value()) == func_Y_väärtus_2 && round_1(INPUT_Y3.value())==func_Y_väärtus_3 && round_1(INPUT_Y4.value())==func_Y_väärtus_4 && round_1(INPUT_Y5.value())==func_Y_väärtus_5 && round_1(INPUT_Y6.value()) == func_Y_väärtus_6 && round_1(INPUT_Y7.value()) == func_Y_väärtus_7){
  ...
  // PUNKT A
  if ( (((round_0(X_koordinaadid[0]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[0])) && (-1*((round_0(Y_koordinaadid[0]/4)*4)-(height-teksti_kasti_kõrgus)/2)/40) == func_Y_väärtus_1 ){
  ...
  // PUNKT B
  if ( (((round_0(X_koordinaadid[1]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[1])) && (-1*((round_0(Y_koordinaadid[1]/4)*4)-(height-teksti_kasti_kõrgus)/2)/40) == func_Y_väärtus_2 ){
  ...
  // PUNKT C
    if ( (((round_0(X_koordinaadid[2]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[2])) && (-1*((round_0(Y_koordinaadid[2]/4)*4)-(height-teksti_kasti_kõrgus)/2)/40) == func_Y_väärtus_3 ){
  ...
  // PUNKT D
    if ( (((round_0(X_koordinaadid[3]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[3])) && (-1*((round_0(Y_koordinaadid[3]/4)*4)-(height-teksti_kasti_kõrgus)/2)/40) == func_Y_väärtus_4 ){
  ...
  // PUNKT E
    if ( (((round_0(X_koordinaadid[4]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[4])) && (-1*((round_0(Y_koordinaadid[4]/4)*4)-(height-teksti_kasti_kõrgus)/2)/40) == func_Y_väärtus_5 ){
  ...
  // PUNKT F
    if ( (((round_0(X_koordinaadid[5]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[5])) && (-1*((round_0(Y_koordinaadid[5]/4)*4)-(height-teksti_kasti_kõrgus)/2)/40) == func_Y_väärtus_6 ){
  ...
  // PUNKT G
    if ( (((round_0(X_koordinaadid[6]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[6])) && (-1*((round_0(Y_koordinaadid[6]/4)*4)-(height-teksti_kasti_kõrgus)/2)/40) == func_Y_väärtus_7 ){
  ...
  //  ########################## KAS KOGU ÜL KORRAS? ##################################
    if (condition_for_finishing_point_B==true && condition_for_finishing_point_A==true && condition_for_finishing_table==true && condition_for_finishing_point_C==true && condition_for_finishing_point_D==true && condition_for_finishing_point_E==true && condition_for_finishing_point_F==true && condition_for_finishing_point_G==true ){
...
function graafik(xmin,xmax, jaotiste_arv) {
    ...
    if (condition_for_finishing_point_A == true && condition_for_finishing_point_B == true && condition_for_finishing_table==true && condition_for_finishing_point_C==true && condition_for_finishing_point_D==true && condition_for_finishing_point_E==true && condition_for_finishing_point_F==true && condition_for_finishing_point_G==true) {
  //----- Määramispiirkond X -----
  var i;
  var j;
   for (i = xmin , j = 0; i <=xmax ; i = i+0.1, j=j+1  ) {
     X[j]=i;
     Y[j]=ruutliige*X[j]*X[j]+lineaarliige*X[j]+vabaliige_B; //----- Muutumispiirkond Y -----
   }
